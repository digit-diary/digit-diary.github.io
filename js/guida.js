  ...
  return [
    ...
    },
    {
      ...
      righe: [
        ...
        'Colonne finali: <b>OL</b> (ore effettivamente lavorate: dall entrata all uscita, senza il supplemento del 10% notturno e senza malattie, vacanze, CGF, permessi, maternita, matrimonio, militare, nascita, protezione civile, trasloco e assistenza familiare), <b>D</b> e <b>N</b> (turni diurni e notturni), <b>OD</b> (ore dovute), <b>OP</b> (ore pianificate: turni piu le assenze retribuite come le vacanze, e la cifra che fa il saldo), <b>SM</b> (saldo del mese: OP meno OD), <b>YTD</b> (saldo da inizio anno). Si aggiornano da sole a ogni modifica.',
      ],
    },
    {
      area: 'piano',
