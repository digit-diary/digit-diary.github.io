  ...
  return [
    ...
    },
    {
      ...
      righe: [
        ...
        'Tutte le regole valgono anche a mano e in ogni cambio (per esigenze, scambio con restituzione, cerca cambio, copertura malattia): riposo di 11 ore, massimo giorni consecutivi (contati anche <b>a cavallo tra un mese e l altro</b>), <b>accompagnamento</b> (chi e segnato accompagnato non deve restare da solo nel suo gruppo quel giorno) e <b>avviso se il collaboratore non e formato</b> per quel turno. Il controllo vale per tutti i collaboratori toccati e per tutti i giorni coinvolti, restituzione compresa. Si puo confermare lo stesso, ma la segnalazione resta scritta nel commento della cella. I commenti automatici si possono sempre modificare o cancellare col tasto destro.',
    ...
    },
    {
      ...
      righe: [
        ...
        'Colonne finali: <b>OL</b> (ore effettivamente lavorate: dall entrata all uscita, senza il supplemento del 10% notturno e senza malattie, vacanze, CGF, permessi, maternita, matrimonio, militare, nascita, protezione civile, trasloco e assistenza familiare), <b>D</b> e <b>N</b> (turni diurni e notturni), <b>OD</b> (ore dovute), <b>OP</b> (ore pianificate: turni piu le assenze retribuite come le vacanze, e la cifra che fa il saldo), <b>SM</b> (saldo del mese: OP meno OD), <b>YTD</b> (saldo da inizio anno). Si aggiornano da sole a ogni modifica. Le <b>assenze retribuite</b> (vacanza, malattia, infortunio, CGF, permesso, maternita, matrimonio, militare, nascita, protezione civile, trasloco, assistenza familiare, funerale) valgono in ore <b>secondo la percentuale d impiego</b>: una giornata di vacanza vale 5.857 ore al 100%, 4.686 all 80% e 2.929 al 50%. Le ore di presenza effettiva (corsi, JG, ufficio, uscita per servizio, formazione) restano invece fisse per tutti. La spunta si regola voce per voce nella scheda Codici.',
      ],
    },
    {
      area: 'piano',
