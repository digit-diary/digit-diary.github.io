const CACHE_NAME = 'diario-cl-v281';
const SHELL_URLS = ['/', '/manifest.json', '/logo_casino.png', '/icon-192.png', '/icon-512.png',
  ...
  '/js/maison-core.js', '/js/maison-budget.js', '/js/maison-helpers.js', '/js/piano-regole.js', '/js/piano-core.js', '/js/piano-genera.js', '/js/piano-config.js', '/js/piano-gestione.js', '/js/piano-cambi.js', '/js/piano-schede.js', '/js/piano-impostazioni.js', '/js/piano-celle.js', '/js/piano-briefing-ui.js', '/js/piano-extra.js', '/js/pause-engine.js',
  '/js/guida.js',
