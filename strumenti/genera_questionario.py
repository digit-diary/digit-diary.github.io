...
matrice = {
 ...
 'ptab_crediti':['V','M','M','V','M'],'ptab_calendario':['V','M','M','M','V'],'ptab_briefing':['V','M','M','M','-'],'ptab_vacanze':['V','M','M','V','V'],'ptab_saldo':['V','M','M','V','M'],'ptab_recupero':['-','M','M','V','-'],'ptab_timbrature':['V','M','M','M','M'],'ptab_statistiche':['V','M','M','V','V'],'ptab_benessere':['V','M','M','V','V'],'ptab_storico':['-','M','M','V','-'],'ptab_formulari':['V','M','M','V','V'],'ptab_turni':['V','M','M','V','M'],'ptab_regole':['V','M','M','V','M'],'ptab_festivi':['V','M','M','V','M'],'ptab_impostazioni':['-','M','M','V','M'],'ptab_guida':['V','V','V','V','V'],
...
sez(B, 'R · Incentivi', 'Sistema punti, accensione globale = ' + ('si' if punti.get('attivo') else 'no') + ', notifiche "' + str(punti.get('notifiche','')) + '", equita su ' + str(imp.get('equita_mesi','12')) + ' mesi.', [
 ...
 ('I valutatori della scheda annuale sono un elenco per settore in Impostazioni (Personale): nella scheda il campo Valutatore propone quei nomi e parte da chi e collegato se e fra i valutatori; il nome resta comunque scrivibile.', 'Slots: Fertitta, Pisano, Bushi, Pistocchi, Rondinella, Fattorini.'),
...
sez(B, 'S · Moduli disciplinari e alert', '', [
 ...
 ('Il responsabile di settore sui moduli si imposta per settore (Slots: %s; Tavoli, Valet, Cleaning da compilare).' % (J('moduli_responsabili', {}).get('slots') or 'da compilare'), 'Modulo Slots con il nome del responsabile gia proposto.'),
 ...
 ('Vacanze: una settimana Definitiva va nel piano e conta nel saldo; una Provvisoria resta in elenco in giallo senza toccare piano e saldo; il cambio e registrato.', 'Settimana 43 provvisoria: ottobre senza V per quei giorni.'),
